...
function addFiles {
    ...
    # 3901034-06
    local ID=$2
    # This is zero padded as it comes from the identifier that padds the part after '-' to two digits
    local PADDED_SHOT_NO=${ID#*-}
    local NOT_PADDED_SHOT_NO
    NOT_PADDED_SHOT_NO=$(printf "%g\n" "$PADDED_SHOT_NO")
